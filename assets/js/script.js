...
$(document).ready(function () {
    // método utilizado para iniciar la búsqueda a través de la API
    $("#form").submit(function (e) {
        
        e.preventDefault();
        const sp_number = $("#sp_number");
        const idSH = sp_number.val() //valor utilizado para determinar qué carácter se mostrará
        ...
        if (idSH == stringValidation || idSH > 731 || idSH < 1) { 
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: `https://superheroapi.com/api.php/10225865940492837/${idSH}`, //Esta URL se utilizará para recuperar un array
